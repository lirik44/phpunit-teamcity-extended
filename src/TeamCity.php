...
//This file should change ./vendor/phpunit/phpunit/src/Util/Log/TeamCity.php
//testMetadata added in addError и addFailure
...
final class TeamCity extends DefaultResultPrinter
{
    ...
    public function addError(Test $test, Throwable $t, float $time): void
    {
        ...
        //Publish description for the test, that provide in @description annotation in test
        ...
        //Publish mono.log data, you can GREP any log file in $test->monoLog variable
        if ($test->monoLog != NULL) {
            $this->write("\n##teamcity[publishArtifacts './report/logs/$test->monoLog => ./logs']\n");
            $this->printEventWithoutFlow(
                'testMetadata',
                [
                    'testName' => $test->getName(),
                    'type'     => 'artifact',
                    'value'    => './logs/'.$test->monoLog,
                    'name'     => 'mono.log',
                ]
            );
        }
    ...
    private function printEventWithoutFlow(string $eventName, array $params = []): void
    {
        $this->write("\n##teamcity[{$eventName}");
